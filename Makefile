...
UNIVCORE	:=	RenderD7 RenderD7/internal RenderD7/external RenderD7/external/tween-engine/include/ RenderD7/external/tween-engine/include/TweenEngine RenderD7/external/tween-engine/source
...
ROMFS		:=	romfs
GFXBUILD	:=	$(ROMFS)/gfx
APP_AUTHOR	:=	PolyMars, Tobi-D7
APP_DESCRIPTION :=      A Ludum Dare 46 Game
ICON		:=	app/icon.png
...
LIBS	:= -lbox2d -lcurl -lstdc++ -lm -lcitro2d -lcitro3d -lctru
...
$(OUTPUT).cia	:	$(OUTPUT).elf $(OUTPUT).smdh
	...
	$(MAKEROM) -f cia -target t -exefslogo -o "../Terri-Fried.cia" -elf "../Terri-Fried.elf" -rsf "../app/build-cia.rsf" -banner "../app/banner.bin" -icon "../app/icon.bin" -logo "../app/splash.lz" -DAPP_ROMFS="$(TOPDIR)/$(ROMFS)" -major $(VERSION_MAJOR) -minor $(VERSION_MINOR) -micro $(VERSION_MICRO) -DAPP_VERSION_MAJOR="$(VERSION_MAJOR)"
#---------------------------------------------------------------------------------
